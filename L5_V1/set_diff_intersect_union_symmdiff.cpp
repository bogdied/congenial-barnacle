...
//    std::vector<int> intersection_stl;
//    std::set_intersection(first.begin(), first.end(), second.begin(), second.end(), std::back_inserter(intersection_stl));
//    print_size_and_elements(intersection_stl);
...
//    std::vector<int> symmetrical_difference_stl;
